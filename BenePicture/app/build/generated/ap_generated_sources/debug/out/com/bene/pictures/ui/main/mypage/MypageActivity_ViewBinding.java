...
public class MypageActivity_ViewBinding extends BaseActivity_ViewBinding {
  ...
  @UiThread
  public MypageActivity_ViewBinding(MypageActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public MypageActivity_ViewBinding(final MypageActivity target, View source) {
    super(target, source);
  ...
  @Override
  public void unbind() {
    MypageActivity target = this.target;
