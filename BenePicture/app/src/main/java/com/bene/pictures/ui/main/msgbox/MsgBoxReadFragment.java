...
public class MsgBoxReadFragment extends MsgBoxBaseFragment {

    public MsgBoxReadFragment() {

    }

    public static MsgBoxReadFragment newInstance() {
        return new MsgBoxReadFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ui_rootView = inflater.inflate(R.layout.fragment_msgbox_read,
                container, false);
    ...
    private void getMsgList() {
        ...
        Net.instance().api.getMsgList(MyInfo.getInstance().userInfo.info.id, 1, page_num)
