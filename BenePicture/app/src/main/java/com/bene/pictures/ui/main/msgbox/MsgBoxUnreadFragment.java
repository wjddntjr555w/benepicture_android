...
public class MsgBoxUnreadFragment extends MsgBoxBaseFragment {

    public MsgBoxUnreadFragment() {

    }

    public static MsgBoxUnreadFragment newInstance() {
        return new MsgBoxUnreadFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ui_rootView = inflater.inflate(R.layout.fragment_msgbox_unread,
                container, false);
    ...
    private void initUI() {
        ...
        adpMsgList = new MsglistAdapter(_activity, new ArrayList<MMsgList.Info>(), new MsglistAdapter.OnMsgListItemListener() {
            ...
            public void OnClickItem(int position) {
                ...
                adpMsgList.removeItem(position);
    ...
    private void getMsgList() {
        ...
        Net.instance().api.getMsgList(MyInfo.getInstance().userInfo.info.id, 0, page_num)
